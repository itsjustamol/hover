...
Context is a menu bar app (no Dock icon).
...
2. **Accessibility** — allow Context under *System Settings → Privacy &
...
| What | Where |
|---|---|
| Model, system prompt, effort | `Sources/Context/ClaudeClient.swift` |
| Hotkey (default ⇧⌘C) | `Sources/Context/AppDelegate.swift` |
| Panel size, positioning, dismissal | `Sources/Context/LookupPanel.swift` |
| Popover UI / glass styling | `Sources/Context/LookupView.swift` |
